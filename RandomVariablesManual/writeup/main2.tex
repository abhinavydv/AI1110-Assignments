...
\vspace{3cm}
\title{AI1110 \\ Random Numbers}
\author{Abhinav Yadav (cs21btech11002)}
% make the title area
\maketitle
\newpage

\question{Q1.3. Find a theoretical expression for $F_U(x)$.}
\solution
The pdf of $F_U(x)$ is given by
\begin{align}
        P_U(x) & = \begin{cases}
                1, & 0 \le x \le 1    \\
                0, & \text{otherwise} \\
...
\question{Q1.5: Verify your result theoretically given that}
\begin{align}
        E[U^k] & = \int_{-\infty}^{\infty}x^kdF_U(x)
\end{align}
